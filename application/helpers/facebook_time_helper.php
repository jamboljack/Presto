...
function facebook_time_ago($timestamp)
{
    ...
    if ($seconds <= 60) {
        ...
        if ($months == 1) {
            return "1 bulan yg lalu";
        } else {
            return "$months bulan yg lalu";
        }
    } else {
        if ($years == 1) {
            return "1 tahun yg lalu";
        } else {
            return "$years tahun yg lalu";
        }
    }
}

/* End of file welcome.php */
/* Location: ./application/helpers/facebook_time_ago_helper.php */
