        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Tipe Bayar</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?=site_url('admin/home');?>">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="#">Data Master</a></li>
                                <li class="breadcrumb-item" active>Tipe Bayar</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title"><i data-feather='list'></i> Daftar Tipe Bayar</h4>
...
$(document).ready(function() {
    $( "#formInput" ).validate({
        ...
        messages: {
            nama: { required :'Nama Tipe Bayar required' }
        },
        ...
        <div class="modal-content">
            ...
            <form id="formInput" name="formInput" method="post" class="form form-horizontal">
                <div class="modal-body">
                    <label class="mb-1">Nama Tipe Bayar</label>
                    <div class="mb-1">
                        <input type="text" class="form-control" placeholder="Input Nama Tipe Bayar" name="nama" id="nama" autocomplete="off">
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <label class="mb-1">Nama Tipe Bayar</label>
                    <div class="mb-1">
                        <input type="text" class="form-control" placeholder="Input Nama Tipe Bayar" name="nama" id="tipe_nama" autocomplete="off">
                    </div>
                </div>
                <div class="modal-footer">
