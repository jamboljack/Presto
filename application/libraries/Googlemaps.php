...
class Googlemaps {
    ...
    var $apiKey                     = 'AIzaSyBfE2AToW48CXB3ArjsCwyS4O7y9Lz2OEU';                        
    ...
    var $center                     = "-6.8062466, 110.8399483";        // Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
