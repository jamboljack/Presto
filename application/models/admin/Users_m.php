...
{
    public $table         = 'presto_users';
    public $column_order  = array(null, null, 'user_username', 'user_nama', 'user_level', 'user_status');
    public $column_search = array('user_username', 'user_nama', 'user_level', 'user_status');
    public $order         = array('user_nama' => 'asc');
